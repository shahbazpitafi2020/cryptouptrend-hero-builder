...
const fallbackArticles = [
  { title: "Tether Gold Reserve Switzerland: Massive Crypto Backing Revealed", category: "Altcoin Update", published_at: null, featured_image_url: null, slug: "" },
  { title: "Bitcoin Rises From One-Month Low: Crypto Markets Today", category: "Altcoin Update", published_at: null, featured_image_url: null, slug: "" },
];
    ...
    <section id="altcoin-updates" className="container py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[2px]">
        {articles.map((article, i) => {
          ...
          return (
            <Link key={i} to={slug ? `/post/${slug}` : "#"} className="relative block overflow-hidden group min-h-[260px]">
              <img
